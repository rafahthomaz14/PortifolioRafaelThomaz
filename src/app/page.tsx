...
export default function Home() {
    return (
        <>
            ...
            />
            <h1 className="text-3xl lg:text-4xl font-bold lg:mb-[-5px] m-10">Sejam bem-vindos ao meu portfólio!</h1>
            ...
            <div className="flex flex-col lg:flex-row">
                <div className="lg:p-10 flex flex-col items-center justify-center lg:items-start lg:justify-start">
                    ...
                    <a href="/Curriculo.pdf" download="Curriculo-Rafael-Thomaz.pdf" className="w-100">
