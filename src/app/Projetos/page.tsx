            ...
            <div className="p-4 lg:p-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="flex flex-col items-center bg-gray-200 p-3 rounded-2xl ">
                    ...
                    <div className="flex w-[100%] justify-between">
                        ...
                        <Button className=" w-[49%] mt-2"><a href="https://github.com/rafahthomaz14/School_Canteen" target="_blank">GitHub</a></Button>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center bg-gray-200 p-3 rounded-2xl ">
                    ...
                    <div className="flex w-[100%] justify-between">
                        <Button className=" w-[49%] mt-2">Sobre</Button>
                        <Button className=" w-[49%] mt-2"><a href="https://github.com/rafahthomaz14/MRE_Solucoes" target="_blank">GitHub</a></Button>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center bg-gray-200 p-3 rounded-2xl ">
                    ...
                    <div className="flex w-[100%] justify-between">
                        <Button className=" w-[49%] mt-2">Sobre</Button>
                        <Button className=" w-[49%] mt-2"><a href="https://github.com/rafahthomaz14/Projeto_Plantech" target="_blank">GitHub</a></Button>
                    </div>
                </div>
